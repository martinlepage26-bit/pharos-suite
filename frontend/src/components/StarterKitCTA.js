...
const StarterKitCTA = () => {
  ...
  return (
    <div className="bg-[linear-gradient(135deg,#0D0A2E_0%,#0D0A2E_40%,#1A1555_70%,#2D2380_100%)] rounded-2xl p-8 text-white shadow-[0_8px_32px_rgba(42,32,107,0.4)] relative overflow-hidden" data-testid="starter-kit-cta">
      {/* Shine effect */}
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <div className="flex-1 relative">
          ...
          <input
            ...
            required
            className="w-full pl-10 pr-4 py-3 rounded-lg bg-white text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0D0A2E]"
