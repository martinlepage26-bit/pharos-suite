  ...
  return (
    <div className="min-h-screen bg-[#F6F7FB] py-12 px-6 md:px-12" data-testid="admin-page">
      <div className="max-w-5xl mx-auto">
        <h1 className="font-serif text-6xl font-semibold text-[#0B0F1A] mb-6">Admin</h1>
        ...
        {activeTab === 'publications' && (
          <div>
            <div className="flex items-center justify-between mb-6">
              <h2 className="font-serif text-6xl font-semibold text-[#0B0F1A]">{t.admin.publications}</h2>
        ...
        {activeTab === 'bookings' && (
          <div>
            <h2 className="font-serif text-6xl font-semibold text-[#0B0F1A] mb-6">{t.admin.bookingsList}</h2>
            {bookings.length === 0 ? (
