  ...
  return (
    <div className="min-h-screen bg-[#F6F7FB] py-12 px-6 md:px-12" data-testid="services-page">
      <div className="max-w-5xl mx-auto">
        <h1 className="font-serif text-6xl md:text-6xl font-semibold text-[#0B0F1A] mb-4">{t.services.title}</h1>
        ...
        <div className="card mb-12">
          <h2 className="font-serif text-6xl font-semibold text-[#0B0F1A] mb-4">{t.services.whatIDeliver}</h2>
        ...
        <h2 className="font-serif text-6xl font-semibold text-[#0B0F1A] mb-6">{t.services.coreOffers}</h2>
              ...
              <div key={key} className="card card-hover" data-testid={`core-offer-${index}`}>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-serif text-6xl font-semibold text-[#0B0F1A] mb-2">{offer.title}</h3>
        ...
        <h2 className="font-serif text-6xl font-semibold text-[#0B0F1A] mb-4">{t.services.pricingTitle}</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          {pricingKeys.map((key, index) => (
            <div key={key} className="card" data-testid={`pricing-factor-${index}`}>
              <h3 className="font-serif text-6xl font-semibold text-[#0B0F1A] mb-3">{t.services.pricing[key].title}</h3>
