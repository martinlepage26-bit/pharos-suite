  ...
  return (
    <div className="min-h-screen bg-[#F6F7FB] py-12 px-6 md:px-12" data-testid="about-page">
      <div className="max-w-4xl mx-auto">
        <h1 className="font-serif text-4xl md:text-5xl font-semibold text-[#0B0F1A] mb-4">{t.about.title}</h1>
        ...
        <div className="card mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {stepKeys.map((key, i) => (
              <div key={key} className="bg-[#F6F7FB] rounded-lg p-5 border-t-3 border-[#180E66]" data-testid={`practice-step-${i + 1}`}>
                <div className="flex items-center gap-3 mb-3">
                  <span className="w-8 h-8 rounded-full bg-[#180E66] text-white flex items-center justify-center font-semibold text-sm">{i + 1}</span>
                  <h3 className="font-serif font-semibold text-[#0B0F1A] underline decoration-[#180E66]">{t.about.steps[key].title}</h3>
                </div>
        ...
        <div className="card mb-8">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              <Link to="/portfolio" className="inline-flex items-center gap-2 text-[#180E66] font-medium hover:gap-3 transition-all group" data-testid="portfolio-link">
        ...
        <div className="card border-l-4 border-[#180E66]">
          <p className="text-xs tracking-widest text-[#180E66] uppercase mb-2">{t.about.featuredResearch}</p>
          ...
          <Link to="/sealed-card" className="inline-flex items-center gap-2 text-[#180E66] font-medium text-sm hover:gap-3 transition-all">
