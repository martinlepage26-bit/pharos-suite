    ...
    <div className="min-h-screen bg-[#F6F7FB] py-12 px-6 md:px-12" data-testid="about-page">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="card mb-8">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              <Link to="/portfolio" className="inline-flex items-center gap-2 text-[#0D0A2E] font-medium hover:gap-3 transition-all group" data-testid="portfolio-link">
        ...
        <div className="card border-l-4 border-[#0D0A2E]">
          ...
          <Link to="/sealed-card" className="inline-flex items-center gap-2 text-[#0D0A2E] font-medium text-sm hover:gap-3 transition-all">
