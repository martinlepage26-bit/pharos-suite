...
const ABOUT_COPY = {
  en: {
    ...
    modulesTitle: 'CompassAI & Aurora',
    modulesBody: 'CompassAI is the PHAROS governance application developed by Martin Lepage in accordance with Deterministic AI governance models by InfraFabric, with permission. Aurora is the intake and document-processing workflow within CompassAI. Their browser surfaces remain under PHAROS while separate standalone hosting is still being staged.',
    modules: [
      {
        title: 'Aurora',
        description: 'The intake and document-evidence workflow within CompassAI, presented today through the PHAROS shell.',
        portalPath: '/portal/compassai/aurora'
      },
      {
        title: 'CompassAI',
        description: 'The PHAROS governance application, with Aurora handling intake and document processing within it.',
  ...
  fr: {
    ...
    modulesTitle: 'CompassAI et Aurora',
    modulesBody: 'CompassAI est l’application de gouvernance PHAROS développée par Martin Lepage conformément aux modèles de gouvernance déterministe d’InfraFabric, avec permission. Aurora est le workflow d’accueil et de traitement documentaire à l’intérieur de CompassAI. Leurs surfaces navigateur demeurent sous PHAROS tant qu’un hébergement autonome distinct n’est pas encore stabilisé.',
    modules: [
      {
        title: 'Aurora',
        description: 'Le workflow d’accueil et de preuve documentaire à l’intérieur de CompassAI, présenté aujourd’hui via la coquille PHAROS.',
        portalPath: '/portal/compassai/aurora'
      },
      {
        title: 'CompassAI',
        description: 'L’application de gouvernance PHAROS, avec Aurora pour l’accueil et le traitement documentaire en son sein.',
        portalPath: '/portal/compassai'
      }
    ],
