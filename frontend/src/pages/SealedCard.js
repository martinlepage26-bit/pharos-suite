  ...
  return (
    <div className="min-h-screen bg-[#F6F7FB] py-12 px-6 md:px-12" data-testid="sealed-card-page">
      <div className="max-w-4xl mx-auto">
        <div className="mb-12">
          <p className="text-xs tracking-widest text-[#180E66] uppercase mb-3">{t.sealedCard.researchProtocol}</p>
        ...
        <a href={PDF_URL} target="_blank" rel="noopener noreferrer" className="block mb-8 p-6 bg-gradient-to-r from-[#180E66] to-[#180E66] rounded-2xl text-white hover:shadow-xl transition-all group" data-testid="pdf-download">
        ...
        <div className="card mb-8">
          <h2 className="font-serif text-2xl font-semibold text-[#0B0F1A] mb-4 flex items-center gap-3">
            <BookOpen className="w-6 h-6 text-[#180E66]" />{t.sealedCard.introduction}
          </h2>
        ...
        <div className="card mb-8">
          <h2 className="font-serif text-2xl font-semibold text-[#0B0F1A] mb-6 flex items-center gap-3">
            <Sparkles className="w-6 h-6 text-[#180E66]" />{t.sealedCard.keyConcepts}
          </h2>
          <div className="grid md:grid-cols-2 gap-4">
            {t.sealedCard.concepts.map((item, i) => (
              <div key={i} className="p-4 bg-[#F6F7FB] rounded-xl border-l-3 border-[#180E66]">
        ...
        <div className="card mb-8">
          <h2 className="font-serif text-2xl font-semibold text-[#0B0F1A] mb-6 flex items-center gap-3">
            <Eye className="w-6 h-6 text-[#180E66]" />{t.sealedCard.governancePrinciples}
          </h2>
          <div className="space-y-4">
        ...
        <div className="card mb-8 border-l-4 border-[#180E66]">
          ...
          <ul className="text-gray-600 space-y-2 ml-4">
            {t.sealedCard.conclusionItems.map((item, i) => (
              <li key={i} className="flex items-start gap-2"><span className="text-[#180E66] mt-1">•</span>{item}</li>
            ))}
          </ul>
        </div>
