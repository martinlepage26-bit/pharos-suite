...
const ASSURANCE_COPY = {
  en: {
    ...
    supports: [
      ...
      'CompassAI remains under the PHAROS surface, with Aurora operating as its intake workflow, until hosting, lineage, and review paths are ready for standalone public presentation.'
    ],
  ...
  fr: {
    ...
    supports: [
      ...
      'CompassAI reste sous la surface PHAROS, avec Aurora comme workflow d accueil, tant que l hebergement, le lignage et les parcours de revue ne sont pas prets pour une presentation publique autonome.'
    ],
