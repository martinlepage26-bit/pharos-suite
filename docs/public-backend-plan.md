...
Those names correspond to the CompassAI governance surface and the current Aurora compatibility surface inside PHAROS, but their standalone public hosting is still a separate decision.
